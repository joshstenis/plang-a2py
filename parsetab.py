...
_lr_productions = [
  ...
  ('foreach -> FOREACH ID IN LPAREN a_fact COLON a_fact RPAREN stmt','foreach',9,'p_foreach','ply-parser.py',119),
  ...
  ('a_expr -> a_expr ADD a_term','a_expr',3,'p_a_expr','ply-parser.py',129),
  ('a_expr -> a_expr SUB a_term','a_expr',3,'p_a_expr','ply-parser.py',130),
  ('a_expr -> a_term','a_expr',1,'p_a_expr','ply-parser.py',131),
  ('a_term -> a_term MUL a_fact','a_term',3,'p_a_term','ply-parser.py',134),
  ('a_term -> a_term DIV a_fact','a_term',3,'p_a_term','ply-parser.py',135),
  ('a_term -> a_fact','a_term',1,'p_a_term','ply-parser.py',136),
  ('a_fact -> varref','a_fact',1,'p_a_fact','ply-parser.py',139),
  ('a_fact -> NUM','a_fact',1,'p_a_fact','ply-parser.py',140),
  ('a_fact -> LITERAL_STR','a_fact',1,'p_a_fact','ply-parser.py',141),
  ('a_fact -> SUB a_fact','a_fact',2,'p_a_fact','ply-parser.py',142),
  ('a_fact -> LPAREN a_expr RPAREN','a_fact',3,'p_a_fact','ply-parser.py',143),
  ('varref -> ID','varref',1,'p_varref','ply-parser.py',146),
  ('varref -> varref LBRACK a_expr RBRACK','varref',4,'p_varref','ply-parser.py',147),
  ('l_expr -> l_expr AND l_term','l_expr',3,'p_l_expr','ply-parser.py',150),
  ('l_expr -> l_term','l_expr',1,'p_l_expr','ply-parser.py',151),
  ('l_term -> l_term OR l_fact','l_term',3,'p_l_term','ply-parser.py',154),
  ('l_term -> l_fact','l_term',1,'p_l_term','ply-parser.py',155),
  ('l_fact -> l_fact oprel a_expr','l_fact',3,'p_l_fact','ply-parser.py',158),
  ('l_fact -> a_expr','l_fact',1,'p_l_fact','ply-parser.py',159),
  ('l_fact -> LPAREN l_expr RPAREN','l_fact',3,'p_l_fact','ply-parser.py',160),
  ('oprel -> LT','oprel',1,'p_oprel','ply-parser.py',163),
  ('oprel -> GT','oprel',1,'p_oprel','ply-parser.py',164),
  ('oprel -> LEQ','oprel',1,'p_oprel','ply-parser.py',165),
  ('oprel -> GEQ','oprel',1,'p_oprel','ply-parser.py',166),
  ('oprel -> EQ','oprel',1,'p_oprel','ply-parser.py',167),
  ('oprel -> NEQ','oprel',1,'p_oprel','ply-parser.py',168),
  ('varlist -> varref','varlist',1,'p_varlist','ply-parser.py',171),
  ('varlist -> varref COMMA varlist','varlist',3,'p_varlist','ply-parser.py',172),
  ('expr_list -> a_expr','expr_list',1,'p_expr_list','ply-parser.py',175),
  ('expr_list -> expr_list COMMA a_expr','expr_list',3,'p_expr_list','ply-parser.py',176),
]
